...
export default function Contact() {
  return (
    <Page title="Contact" image="Image9.webp">
      <div className="flex flex-col gap-4 xl:h-[calc(100dvh-48px-87px)] md:grid md:grid-cols-2 md:grid-rows-2">
        ...
        <div className="grid grid-cols-2 grid-rows-2 gap-4 aspect-square xl:h-[calc((100dvh-48px-87px-16px)/2)]">
        ...
        <div className="rounded-2xl overflow-clip aspect-square md:aspect-auto md:col-start-1 md:row-start-2 xl:h-[calc((100dvh-48px-87px-16px)/2)] grayscale">
