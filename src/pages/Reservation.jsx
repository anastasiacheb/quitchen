...
export default function Reservation() {
  ...
  return (
    <Page
      ...
      image="Image5.webp">
      <div className="rounded-2xl border border-tertiary flex flex-col p-8 gap-15 md:p-16 xl:px-24 xl:pt-20 xl:gap-20 xl:h-full">
        <div className="flex flex-col gap-4">
          <div className="flex gap-4 w-fit m-auto">
            <img src="assets/icons/Grid.svg" alt="decor" className="w-15" />
            <h2 className="font-forum text-[28px] md:text-[32px] xl:text-[40px] uppercase">Reservation</h2>
